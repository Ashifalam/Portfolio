...
export const getButtonClasses = (variant = 'primary', size = 'md') => {
  const { base, variants, sizes } = designSystem.components.button;
  return `${base} ${variants[variant]} ${sizes[size]}`;
};

export const getCardClasses = (variant = 'default') => {
  const { base, variants } = designSystem.components.card;
  return `${base} ${variants[variant]}`;
};

export const getInputClasses = (variant = 'default', size = 'md') => {
  const { base, variants, sizes } = designSystem.components.input;
  return `${base} ${variants[variant]} ${sizes[size]}`;
};

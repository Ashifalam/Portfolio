        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-secondary-300 mb-6 max-w-md">
              Software Developer specializing in Python, Machine Learning, and AI technologies. 
              Passionate about building intelligent applications and automation solutions.
            </p>
